...
from embedding import SVDEmbedding
...
def main():
    args = docopt("""
    Usage:
        vectors2similarity.py <vocab>, <ppmi>, <svd>, <limit>
""")
    ...
    store_results(path, ("WORDIDS", word2id), ("FREQUENCY",
...
def read_generic(method, word2id):
    ...
    for word1, id1 in word2id.entries():
        for word2, id2 in word2id.entries():
            if word1 != word2:
